...
@jepiq.on(admin_cmd(pattern="(حسابي|مصرفي) ?(.*)"))
...
- مثال: .انشاء حساب الرافدين او تليثون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "تليثون الاسلامي":
        bankn = "مصرف تليثون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "تليثون الاسلامي":
