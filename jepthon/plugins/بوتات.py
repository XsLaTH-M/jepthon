...
async def _(event):
    ...
    async with bot.conversation(chat) as conv:
        try:
            ...
            return
        await event.edit(
            f"الايميل الخاص هو `{response.message.message}`\n[ اضغط هنا لرؤية من رسائل الايميل الواردة]({H_5_7})"
        )
...
async def _(event):
    ...
    async with event.client.conversation(chat) as conv:
        try:
            ...
            await catevent.edit("**╮•⎚ تحـقق من انـك لم تقـم بحظر البوت @H_5_71BoT .. ثم اعـد استخدام الامـر ...🤖♥️**")
            return
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @H_5_7 🎀",parse_mode="html")
  await vois.delete()
...
async def jepvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="⌯︙BY : @H_5_7 🤲🏻☪️",parse_mode="html")
  await vois.delete()
